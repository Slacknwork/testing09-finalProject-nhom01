  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e37]:
      - generic [ref=e38]:
        ...
        - paragraph [ref=e45] [cursor=pointer]: 19/04/2026 – 26/04/2026
          ...
          - generic [ref=e236]:
            ...
            - generic [ref=e247]:
              ...
              - textbox "Email Email" [ref=e254]:
                - /placeholder: Điền tên vào đây...
                - text: weak_1776480231625@mailinator.com
            - generic [ref=e256]:
              ...
              - generic [ref=e296]:
                ...
                - generic [ref=e303] [cursor=pointer]:
                  ...
                  - generic:
                    - img:
                      - img
          - button "Đăng ký" [ref=e309] [cursor=pointer]
  - generic [ref=e310]:
    - dialog:
      - generic [ref=e311]:
        - button "Close" [ref=e312] [cursor=pointer]:
          - img "close" [ref=e314]:
            - img [ref=e315]
        - generic [ref=e318]:
          - heading "Đăng nhập" [level=2] [ref=e319]
          - generic [ref=e320]:
            - generic [ref=e321]: Email
            - textbox "Vui lòng nhập tài khoản" [ref=e322]
          - generic [ref=e323]:
            - generic [ref=e324]: Mật khẩu
            - textbox "Vui lòng nhập mật khẩu" [ref=e325]
          - generic [ref=e326]:
            - button "Đăng ký" [ref=e327] [cursor=pointer]
            - button "Đăng nhập" [ref=e328] [cursor=pointer]
```